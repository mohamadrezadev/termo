        ...
        if (thermalImageInfo && thermalImageInfo.url) {
          try {
            ...
            const newThermalImage: ThermalImage = {
              ...
              // preRenderedThermalUrl can be omitted or set to null initially
              // canvas will be generated by ThermalImageRenderer when needed
            };
            ...
            console.error('Failed to process thermal image from server:', thermalImageInfo.url, processingError);
            // Optionally, inform the user about the processing error
          ...
          console.error('No thermal image URL found in server response for file:', file.name, result);
