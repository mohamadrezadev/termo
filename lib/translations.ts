export const translations = {
  en: {
    ...
    error: "Error",
    success: "Success",
    uploadImage: "Upload thermal image",
  ...
  fa: {
    // App Navigation
    appTitle: "تحلیلگر حرارتی پیشرفته",
    file: "فایل",
    edit: "ویرایش",
    view: "نمایش",
    tools: "ابزارها",
    ...
    saveProjectAs: "ذخیره پروژه با نام...",
    importImage: "وارد کردن تصویر",
    ...
    error: "خطا",
    success: "موفق",
    uploadImage: "بارگذاری تصویر حرارتی",
